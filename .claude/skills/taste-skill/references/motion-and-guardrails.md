<!-- Sections 5-7: context-aware proactivity, canonical motion skeletons, forbidden animation patterns, performance and a11y guardrails, dial definitions.
     Vendored verbatim from Leonxlnx/taste-skill (MIT), skills/taste-skill/SKILL.md.
     Section numbers below refer to that upstream document. -->
