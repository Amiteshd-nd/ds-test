// Page style extractor, lifted verbatim from the TypeUI DESIGN.md Chrome
// extension (bergside/design-md-chrome, MIT) with the chrome.runtime message
// wrapper removed so it can be injected through the Browser pane instead.
// Returns the raw extraction payload; feed that to scripts/generate.mjs.
(function () {
